...
public class FilterDAO {
	DataSource ds;
	public FilterDAO() throws ClassNotFoundException{
	...
	public Map<String, ItemBean> search(String name) throws SQLException{
...
//			System.out.println("1  The type: " + type + ", BID: " + bid + ", Name: " + name + ", Brand: " + brand);
	...
	public Map<String, ItemBean> retrieveType(String type) throws SQLException{
